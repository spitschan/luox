...
describe("calculate", () => {
  ...
  it("returns expected results for spd1_1nm CSV", () => {
    ...
    expect(result.luminanceTotals[0].toFixed(2)).toEqual("38595.33");
  ...
  it("returns expected results for spd1_2nm CSV", () => {
    ...
    expect(result.luminanceTotals[0].toFixed(2)).toEqual("31819.08");
  ...
  it("returns expected results for spd2_1nm CSV", () => {
    ...
    expect(result.luminanceTotals[0].toFixed(2)).toEqual("38347.73");
  ...
  it("returns expected results for spd2_5nm CSV", () => {
    ...
    expect(result.luminanceTotals[0].toFixed(2)).toEqual("1000036.34");
  ...
  it("returns expected results for spd3_5nm CSV", () => {
    ...
    expect(result.luminanceTotals[0].toFixed(2)).toEqual("999991.21");
